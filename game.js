...
Object.defineProperties(Game.prototype, {
    _resizeHandler: {
        ...
        value: function () {
            ...
            this._canvas.style.marginTop = Help.clampMin((window.innerHeight - newHeight) / 2, 0) + "px";
            this._canvas.style.marginLeft = Help.clampMin((window.innerWidth - newWidth) / 2, 0) + "px";
            this._canvas.style.marginBottom = (window.innerHeight - newHeight) / 2 + "px";
            this._canvas.style.marginRight = (window.innerWidth - newWidth) / 2 + "px";
